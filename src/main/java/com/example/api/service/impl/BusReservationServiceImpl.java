...
import com.example.api.mapper.TicketMapper;
import com.example.api.mapper.TripMapper;
import com.example.api.mapper.TripScheduleMapper;
import com.example.api.repository.*;
import com.example.api.service.BusReservationService;
import com.example.api.utils.RandomStringUtil;
...
import static com.example.api.exception.EntityType.*;
import static com.example.api.exception.ExceptionType.*;
...
public class BusReservationServiceImpl implements BusReservationService {
     ...
     * @param destinationStopCode
     * @param tripDate
     * @return list of trip-schedules on given date
     */
    @Override
        ...
        if (trip.isPresent()) {
            ...
            if (tripSchedule.isPresent()) {
                ...
                if (createSchedForTrip) { //create the schedule
                    ...
                    throw exceptionWithId(TRIP, ENTITY_NOT_FOUND, "2", String.valueOf(tripDto.getId()), tripDate);
                }
            }
        }
        throw throwException(TRIP, ENTITY_NOT_FOUND, String.valueOf(tripDto.getId()));
    }
    ...
    private RuntimeException exception(EntityType entityType, ExceptionType exceptionType, String... args) {
        return throwException(entityType, exceptionType, Arrays.toString(args));
    }
    ...
    private RuntimeException exceptionWithId(EntityType entityType, ExceptionType exceptionType, String id, String... args) {
        return throwExceptionWithId(entityType, exceptionType, id, args);
    }

    private RuntimeException throwExceptionWithId(EntityType entityType, ExceptionType exceptionType, String id, String[] args) {
